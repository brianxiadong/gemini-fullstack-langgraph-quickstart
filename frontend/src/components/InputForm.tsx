                            ...
                            <SelectContent className="bg-neutral-700 border-neutral-600 text-neutral-300 cursor-pointer">
                                ...
                                >
                                    <div className="flex items-center">
                                        <Cpu className="h-4 w-4 mr-2 text-green-400" /> Qwen3 32B
                                    </div>
                                </SelectItem>
                                <SelectItem
                                    value="qwen3:14b"
                                ...
                                >
                                    <div className="flex items-center">
                                        <Zap className="h-4 w-4 mr-2 text-blue-400" /> Qwen3 14B
                                    </div>
                                </SelectItem>
                                <SelectItem
                                    value="qwen3:7b"
                                ...
                                >
                                    <div className="flex items-center">
                                        <Zap className="h-4 w-4 mr-2 text-orange-400" /> Qwen3 7B
                                    </div>
                                </SelectItem>
                            </SelectContent>
                        </Select>
